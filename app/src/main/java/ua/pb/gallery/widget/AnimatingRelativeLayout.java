...
/**
 * Created by evasyuk on 30.08.15.
 */
public class AnimatingRelativeLayout extends RelativeLayout {
    ...
    private void initAnimations()  {
        inAnimation = (TranslateAnimation) AnimationUtils.loadAnimation(context, R.anim.in_animation);
        outAnimation = (TranslateAnimation) AnimationUtils.loadAnimation(context, R.anim.out_animation);
    }
